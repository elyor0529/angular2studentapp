System.register(["angular2/core", "angular2/router", '../../models/studentModel', '../../services/studentService'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            StudentAddComponent = (function () {
                function StudentAddComponent(student, service, router) {
                    this.student = student;
                    this.service = service;
                    this.router = router;
                }
                StudentAddComponent.prototype.onSubmit = function () {
                    var _this = this;
                    console.log(this.student);
                    this.service.add(this.student).subscribe(function (data) {
                ...
                StudentAddComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [studentModel_1.StudentModel, studentService_1.StudentService, router_1.Router])
                ], StudentAddComponent);
                return StudentAddComponent;
            }());
            exports_1("StudentAddComponent", StudentAddComponent);
        }
    }
});
